...
# Adapted from https://github.com/mysql/mysql-docker/tree/mysql-server/5.7

set -e

echo "[Entrypoint] MySQL 5.7 based Debian Sid (unstable) Docker Image"
...
EOF
	...
	chown -R mysql:mysql "$DATADIR"
	echo "[Entrypoint] Starting MySQL 5.7"
fi
